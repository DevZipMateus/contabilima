...
const ContactSection = () => {
  return (
    <section id="contato" className="py-16 bg-gradient-to-b from-contabilima-blue/5 to-white">
            ...
            <div className="glass-card rounded-xl p-6 sm:p-8 border-contabilima-blue/20">
              ...
              <div className="mt-8 flex flex-col md:flex-row justify-center gap-4">
                <a 
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-600 text-white rounded-md font-medium hover:bg-green-700 transition-colors"
                >
                ...
                <a 
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-contabilima-blue text-white rounded-md font-medium hover:bg-blue-800 transition-colors"
                >
              ...
              <div className="mt-8 p-4 rounded-lg bg-gray-50 border border-gray-100">
                <h4 className="text-lg font-medium mb-2 text-center">Redes Sociais</h4>
                <div className="flex justify-center">
                  <a 
                    href="https://taggo.one/contabilima" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="bg-contabilima-blue text-white px-6 py-2 rounded-md hover:bg-blue-800 transition-colors inline-flex items-center gap-2"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
